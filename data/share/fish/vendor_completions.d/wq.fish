...
complete -c wq -n "__fish_seen_subcommand_from work" -s S -l sleep -x -d "Sleep before working"
complete -c wq -n "__fish_seen_subcommand_from serve" -s S -l sleep -x -d "Sleep before serving"
